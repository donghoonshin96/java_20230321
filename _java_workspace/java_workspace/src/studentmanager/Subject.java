...
public class Subject {
	/*
	 * 과목클래스 : 한 과목의 정보를 나타내는 클래스 -과목코드, 과목명, 학점, 시수, 교수명, 학기, 분류(전공,교양), 수업시간표
	...
	// 생성자 : 객체를 생성할 때 기본으로 setting 하고자하는 값을 미리 입력받아서 객체를 생성
	...
	public String toString() {
		return "Subject [subCode=" + subCode + ", subName=" + subName + ", subCredit=" + subCredite + ", subTime="
